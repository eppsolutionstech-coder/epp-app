...
import { LayoutDashboard, ShoppingBag, FileText, LogOut, X, User } from "lucide-react";
...
const navItems = [
	{ href: "/employee/dashboard", icon: LayoutDashboard, label: "Dashboard", end: true },
	{ href: "/employee/catalog", icon: ShoppingBag, label: "Browse Products" },
	{ href: "/employee/orders", icon: FileText, label: "My Orders" },
];

...
export function ProfileOrdersTab({ purchases }: ProfileOrdersTabProps) {
	...
	const { data: ordersResponse } = useGetOrders({
		fields: "id, orderNumber, employeeId, status, orderItems.item.images, subtotal, tax, total, paymentType, installmentMonths, installmentCount, installmentAmount, paymentMethod, paymentStatus, orderDate, installments.status",

...
export default function EmployeeCart() {
	const {
		...
		fields: "id, employeeId, item.id, item.sku, item.name, item.retailPrice, item.costPrice, item.stockQuantity, item.images, quantity, item.vendor.name, createdAt, updatedAt",
		limit: 50,
	});

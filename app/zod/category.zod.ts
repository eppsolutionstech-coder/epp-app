...
export const CategoryWithRelationSchema = CategorySchema.extend({
	parent: z
		.object({
			id: z.string(),
			name: z.string(),
...
export type CategoryWithRelation = z.infer<typeof CategoryWithRelationSchema>;

export interface GetAllCategoriesSchema {
	categorys: CategoryWithRelation[];

import { z } from "zod";
import type { ApprovalLevel } from "./approval-level.zod";
...
export interface WorkflowApprovalLevelWithRelation extends CreateWorkflowApprovalLevel {
	approvalLevel: ApprovalLevel;
	workflow: ApprovalWorkflow;
}

export interface GetAllWorkflowApprovalLevels {
	workflowApprovalLevels: WorkflowApprovalLevelWithRelation[];
